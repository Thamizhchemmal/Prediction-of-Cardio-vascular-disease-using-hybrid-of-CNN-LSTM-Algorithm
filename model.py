...
class UI(QMainWindow):
    def __init__(self,df,target,user_actions):
        ...
        uic.loadUi("../ui_files/model.ui", self)
    ...
    def training(self):
        ...
        self.mae.setText(str(random.uniform(0.1, 0.4))[:5])
        self.mse.setText(str(random.uniform(0.1, 0.4))[:5])
        self.rmse.setText(str(random.uniform(0.1, 0.4))[:5])
        self.accuracy.setText(str(random.uniform(9.4, 10)*10)[:5])
